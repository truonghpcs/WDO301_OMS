                    ...
                    <Card id="dialog" bordered={false} >
                        ...
                        >
                            <Form.Item style={{ marginBottom: 3 }}>
                                ...
                                <Divider style={{ marginBottom: 5, fontSize: 19 }} orientation="center">LEARNMASTER</Divider>
                            </Form.Item>
                            ...
                            <Form.Item
                                ...
                                rules={[
                                    ...
                                    {
                                        pattern: new RegExp(/^(?=.*[0-9])(?=.*[a-zA-Z])[a-zA-Z0-9!@#$%^&*()_+]{6,}$/g),
                                        message: 'Mật khẩu phải có ít nhất 6 ký tự, bao gồm chữ cái và số, và có thể chứa các ký tự đặc biệt!',
                                    },
                                ]}
                            >
                                <Input
