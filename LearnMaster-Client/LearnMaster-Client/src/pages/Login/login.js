...
const Login = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      console.log("email or password error", error.response ? error.response.data : error);
    }
  };
      ...
      <Row xl={6} lg={10} md={10} sm={16} xs={20} style={{ margin: 'auto' }}>
        ...
        >
          <Form.Item style={{ marginBottom: 3 }}>
            <Divider style={{ marginBottom: 5, fontSize: 19 }} orientation="center">CHÀO MỪNG BẠN ĐẾN VỚI FIVESTORE!</Divider>
          </Form.Item>
